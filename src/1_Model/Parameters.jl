...
@label @latex_label @prior @flattenable @with_kw struct ModelParameters{T}
    ...
    β::T = 0.984375 | "beta" | L"\beta" | _ | false # discount factor
    λ::T = 0.0579 | "lambda" | L"\lambda" | _ | false # adjustment probability
    ...
    ζ::T = 1 / 4750 | "zeta" | L"\zeta" | _ | false # probability to become entrepreneur
    ...
    Rbar::T = (π * (1.075 .^ 0.25) .- 1.0) | "Rbar" | L"\bar R" | _ | false # borrowing wedge in interest rate
...
@with_kw struct EstimationSettings
    ...
    save_mode_file::String = "7_Saves/HANK_mode.jld2"
    save_posterior_file::String = "7_Saves/HANK_chain.jld2"
