...
function Value_jacob_dct(
    ...
    indk[17] =
        select_comp_ind(reshape(Vk, (n_par.nm, n_par.nk, n_par.ny)), n_par.reduc_value)
    indm[17] =
        select_comp_ind(reshape(Vm, (n_par.nm, n_par.nk, n_par.ny)), n_par.reduc_value)
    return indk, indm, J
end
