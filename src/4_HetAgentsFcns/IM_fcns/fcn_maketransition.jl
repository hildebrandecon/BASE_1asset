function MakeTransition(
    ...
    # Adjustment case
    weight = Array{eltype(k_a_star),3}(undef, 4, n_par.ny, n_par.nk * n_par.nm * n_par.ny)
    targetindex = Array{Int,3}(undef, 4, n_par.ny, n_par.nk * n_par.nm * n_par.ny)
    startindex = Array{Int,3}(undef, 4, n_par.ny, n_par.nk * n_par.nm * n_par.ny)
